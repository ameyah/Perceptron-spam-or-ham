...
class AvgPerceptronLearn():
    class __AvgPerceptronLearn():
        def __init__(self):
    ...
    def __init__(self):
        if AvgPerceptronLearn.__instance is None:
            AvgPerceptronLearn.__instance = AvgPerceptronLearn.__AvgPerceptronLearn()
        self.__dict__['AvgPerceptronLearn__instance'] = AvgPerceptronLearn.__instance
...
def get_command_args():
    ...
    parser.add_argument("-i", "--iterations", default=30, type=int, help='Add if # of iterations need to be changed')
